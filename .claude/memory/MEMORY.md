...
- [Job read / BOQ v836](job-read-boq-v836.md) — prepared permission fix and 50-row BOQ pilot, tests/measurements, pending owner-run migration and deployment; known baseline failures.
