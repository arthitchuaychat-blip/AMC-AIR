/* ============================================================
   app-icons.jsx — clean line icons for materials + UI
   Exposes: window.MatIcon, window.UI (ui icon set)
   ============================================================ */

// Material category / item icons. Simple geometric line art.
const MAT_PATHS = {
  pipe: (
    <g>
  ...
  elbow: (
    <g>
      <path d="M5 19 L5 11 A6 6 0 0 1 11 5 L19 5" />
      <path d="M5 19 L9 19" /><path d="M5 15 L9 15" />
      <path d="M19 5 L19 9" /><path d="M15 5 L15 9" />
    </g>
  ),
  couple: (
    <g>
  ...
  tank: (
    <g>
      ...
      <path d="M10 6 L10 3 L14 3 L14 6" />
  ...
  wire: (
    <g>
      <path d="M3 14 q3 -6 6 0 t6 0 t6 0" />
  ...
  cap: (
    <g>
      <rect x="8" y="4" width="8" height="14" rx="3" />
      <line x1="10" y1="18" x2="10" y2="21" /><line x1="14" y1="18" x2="14" y2="21" />
      <line x1="9" y1="8" x2="15" y2="8" />
    </g>
  ),
  bracket: (
    <g>
      <path d="M4 7 L20 7 L20 11 L8 11 L8 17" />
  ...
  gas: (
    <g>
      ...
      <path d="M12 10 c1.5 1.5 1.5 3 0 4 c-1.5 -1 -1.5 -2.5 0 -4Z" fill="currentColor" stroke="none" />
    </g>
  ),
  rod: (
    <g>
      <line x1="4" y1="20" x2="20" y2="4" />
      <line x1="17" y1="4" x2="20" y2="4" /><line x1="20" y1="7" x2="20" y2="4" />
    </g>
  ),
};

function MatIcon({ name, size = 24, color = "currentColor", strokeWidth = 1.6, style }) {
  return (
...
const UI_PATHS = {
  ...
  withdraw: "M12 3v12m0 0 4-4m-4 4-4-4M5 21h14",         // arrow down out
  ret: "M12 21V9m0 0 4 4m-4-4-4 4M5 3h14",                // arrow up in
...
function UIcon({ name, size = 20, color = "currentColor", strokeWidth = 1.8, style, fill = "none" }) {
  return (
...
Object.assign(window, { MatIcon, UIcon });
