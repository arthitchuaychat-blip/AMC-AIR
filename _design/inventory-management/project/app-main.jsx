/* ============================================================
   app-main.jsx — shell, role routing, tweaks
   ============================================================ */
  ...
  return (
    <div className="app" style={rootStyle}>
      ...
      <TweaksPanel title="Tweaks">
        ...
        <TweakColor label="สีหลัก (Primary)" value={t.primary}
          options={["#4f46e5", "#2563eb", "#0d9488", "#e11d48", "#ea580c", "#111827"]}
          onChange={(v) => setTweak("primary", v)} />
        <TweakSlider label="ความโค้งมุม" value={t.radius} min={6} max={26} step={2} unit="px"
          onChange={(v) => setTweak("radius", v)} />
        <TweakSection label="เลย์เอาต์ · Layout" />
        <TweakRadio label="ความหนาแน่น" value={t.density} options={["compact", "regular", "comfy"]}
          onChange={(v) => setTweak("density", v)} />
        <TweakSelect label="ฟอนต์" value={t.font}
          options={[{ value: "plex", label: "IBM Plex Thai" }, { value: "noto", label: "Noto Sans Thai" }, { value: "anuphan", label: "Anuphan" }]}
