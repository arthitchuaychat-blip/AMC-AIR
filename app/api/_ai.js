...
export async function generateReply({ history, cfg = {}, afterHours = true }) {
  try {
    ...
    const rules = `คุณคือ "น้องหนาว" ผู้ช่วย AI ตอบอัตโนมัติของ AMC AIR ร้านขาย-ติดตั้ง-ล้าง-ซ่อมแอร์ ${afterHours ? "ตอนนี้อยู่นอกเวลาทำการ คุณตอบลูกค้าทางแชตแทนทีมงาน" : "คุณช่วยตอบลูกค้าทางแชตเบื้องต้น ระหว่างที่ทีมงานอาจยังไม่ว่างตอบทันที"}
