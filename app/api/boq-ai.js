...
2. **ท่อน้ำยา (ท่อทองแดง) — แอร์ 1 ชุด = ท่อ 2 ขนาด** (ท่อเล็ก liquid + ท่อใหญ่ suction/gas) → ออกเป็น 2 บรรทัดต่อชุด คนละขนาด ความยาวเท่ากัน
   - ถ้าแบบ/สเปคระบุขนาดท่อของรุ่นนั้น ให้ใช้ตามนั้น · ถ้าไม่ระบุ ใช้**ตารางมาตรฐานตาม BTU** (needsCheck=true): ≤12,000 = 1/4"+3/8" · 18,000 = 1/4"+1/2" · 24,000 = 3/8"+5/8" · 30,000-36,000 = 3/8"+5/8" · 40,000-48,000 = 3/8"+3/4"
   - เลือกรหัสท่อทองแดงจากแคตตาล็อกให้ตรงขนาด (เช่น "ท่อทองแดง 3/8") ทั้ง 2 เส้น
