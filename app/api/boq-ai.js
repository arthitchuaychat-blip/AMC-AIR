...
- **FCU** = คอยล์เย็น/เครื่องตัวใน (indoor) · **CDU** = คอนเดนเซอร์/เครื่องตัวนอก (outdoor) · FCU 1 ตัว = แอร์ 1 ชุด (นับจำนวนเครื่องจากจำนวน FCU)
- **อ่านเลเจนด์/สีของแต่ละตัวเสมอ** แล้วแยกสถานะ: "แอร์เดิมที่ติดอยู่แล้ว" (มักสีส้ม — ไม่ต้องคิดเงินเครื่อง) · "แอร์เดิมย้าย/ติดตั้งใหม่" (มักสีเขียว — คิดค่าติดตั้ง/ย้าย ไม่คิดค่าเครื่อง) · "ติดตั้งแอร์ใหม่" (มักสีฟ้า — คิดทั้งเครื่อง+ติดตั้ง)
- **ค่าเริ่มต้น: เสนอราคาเฉพาะงาน "ใหม่" + "ย้าย/ติดใหม่"** — งานเดิมที่อยู่แล้วไม่ต้องคิด (เว้นบรีฟสั่งเป็นอย่างอื่น) · ต้องสรุปให้ชัดว่านับตัวไหนบ้าง
- แบบมักมีโน้ต ใช้ประเมินวัสดุ/บริการ: "ต้องการเมนไฟเพิ่ม X จุด" (→ งานเดินไฟ/เบรกเกอร์ X จุด), "ท่อน้ำทิ้ง...", "ท่อ 9 m / ไม่เกิน 4 m" (→ ความยาวท่อทองแดง/น้ำทิ้งต่อจุด), "ใส่ปั๊มน้ำ/ปั๊มน้ำทิ้ง" (→ ปั๊มน้ำทิ้ง)
- **BTU มักไม่เขียนบนแบบ** — ถ้าไม่มี BTU (ทั้งในแบบและสเปค) ห้ามเดารุ่นเจาะจง ให้ตั้ง code="" name="แอร์ [ตำแหน่ง] — รอระบุ BTU/รุ่น" needsCheck=true แล้วบอกในสรุปว่าต้องขอ BTU
