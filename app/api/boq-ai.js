...
- **"SCHEMATIC DIAGRAM – AIR COND." คือแหล่งข้อมูล FCU ที่แม่นที่สุด** ถ้ามีภาพนี้ ให้ยึดเป็นหลัก: อ่านทุกกล่อง FCU-x + BTU/h + ชื่อห้อง + แยกชั้น (ชั้น1/2/3) + ดูสัญลักษณ์เครื่องว่าเป็นติดผนัง (มีใบพัด 3 อันด้านล่าง) หรือคาสเซ็ท/ฝังฝ้า (กล่องสี่เหลี่ยมมีตะแกรง) · ส่วนภาพ "ผังระบบปรับอากาศชั้น x" (floor plan) ใช้ดูแนวเดินท่อ FCU→CDU + ระยะ (เส้น grid มี dimension เป็นเมตร เช่น 3.00/6.00/4.00/8.00) เพื่อประเมินความยาวท่อ
