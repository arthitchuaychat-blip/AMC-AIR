...
export default function SubcontractRateSettings({value,canEdit,onSaved}) {
 ...
 return <div className="card"><h2>ตั้งค่าแรงช่างซัพ</h2><p>ใช้ราคาขายในใบเสนอราคาหลังส่วนลด ก่อน VAT วัสดุทุกชนิดใช้อัตราวัสดุ ยกเว้นเครื่องแอร์ อะไหล่ และอุปกรณ์เสริม</p>
