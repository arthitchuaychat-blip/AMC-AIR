...
const LABEL = { boq: (n) => "BOQ " + n, quote: (n) => n, job: (n) => "งาน " + n, invoice: (n) => "บิล " + n, receipt: (n) => "ใบเสร็จ " + n };

export default function DocChips({ boqNo, quoteNo, jobNos = [], invoiceNos = [], receiptNos = [], self, onOpen }) {
  const items = [];
