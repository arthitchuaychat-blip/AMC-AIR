...
// รายละเอียดเงินเดือนรายวัน — กดจากช่องไหนก็ได้ในตาราง: OT วันไหนกี่ ชม. · สายวันไหนกี่นาที · ขาด/ลา/วันหยุด/เบิกล่วงหน้า ครบทุกช่อง
function PayDetailModal({ r, c, advRows, settings, period, onClose }) {
