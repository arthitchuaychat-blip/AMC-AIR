          ...
          <div className={"card job-card doc2" + (b.status === "cancelled" ? " closed" : "")} key={b.billing_no}>
            ...
            {(() => {
              ...
              return [...ch.quotes].map((qn, i) => {
                const g = docLinks.byQuote[qn] || {};
                return <DocChips jobStatusBy={docLinks.jobStatusBy || {}} key={qn + i} boqNo={g.boqNo} quoteNo={qn} jobNos={g.jobNos} invoiceNos={g.invoiceNos} receiptNos={g.receiptNos} poNos={g.poNos} creditNos={g.creditNos} debitNos={g.debitNos} onOpen={openPeek} />;
              });
            })()}
      ...
      {printB && (() => {
        ...
        return (
          <DocSlip currencyUnit="บาท" company={co} titleTh="ใบวางบิล / ใบแจ้งหนี้รวม" titleEn="BILLING NOTE" docNo={printB.billing_no}
            metaRows={[{ label: "วันที่", value: printB.issue_date }, { label: "จำนวนใบแจ้งหนี้", value: String(liveInv(printB).length) }]}
