            ...
            <div className="doc-cust">
              ...
              <div className="doc-cust-r">
                ...
                <div className="doc-cust-line">
                  {customer.taxId ? <>เลขประจำตัวผู้เสียภาษี {customer.taxId} ({customer.branch || "สำนักงานใหญ่"})</> : null}
                ...
                {(customer.siteName || customer.siteAddress || customer.siteContactName || customer.siteContactPhone) && (
                  <div className="doc-cust-site">
                    ...
                    {(customer.siteContactName || customer.siteContactPhone) && <div className="doc-cust-line">ผู้ติดต่อหน้างาน {customer.siteContactName || ""}{customer.siteContactPhone ? ` ${customer.siteContactPhone}` : ""}</div>}
                  </div>
                )}
              </div>
            </div>
