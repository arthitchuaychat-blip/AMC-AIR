...
const BUILD = "2026-07-20·ด่วน 2: หน้าเตรียมวัสดุกลับมาโหลดได้ — query 2 อันไปลงผิดฟังก์ชัน (ผมทำพังเองตอน v471) และหน้าใบสั่งซื้อเลิกยิง query ทิ้งเปล่า 2 อันทุกครั้งที่เปิด v483";
