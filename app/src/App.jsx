...
const BUILD = "v852 · เบิกจ่าย: ใบรวมจ่าย (แม่) ↔ ใบเบิกเดิม (ลูก) — ใบเดิมไม่ถูกปิดเป็นไม่อนุมัติ · ผู้เบิกเห็นสถานะ+สลิป · ใบรวมโชว์หลายลูกค้า · แยกออกจากใบรวมได้";
            ...
            const renderItem = (id) => {
              ...
              return (
                ...
                <a key={id} href={"#" + id} aria-current={view === id ? "page" : undefined} title={primary} style={{ textDecoration: "none" }} className={"nav-item" + (view === id ? " on" : "")}
                  ...
                  <FloatingIcon name={n.icon} menuId={id} size={34} />
