...
const BUILD = "2026-07-17·HR ยกชุด: อุดเพดาน 1000 แถว (ใบลา/เบิก/เวลาเข้างาน) + โหมดรับรอง OT (mig 144) + โชว์เซลฟี่/GPS แท็บวันนี้ + เตือนลืมเช็คเอาท์ 7 วันหลัง v423";
