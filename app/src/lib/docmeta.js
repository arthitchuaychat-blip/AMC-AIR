...
export const TYPE_LABEL = { quote: "ใบเสนอ", invoice: "ใบแจ้งหนี้", receipt: "ใบเสร็จ", job: "ใบงาน", po: "ใบสั่งซื้อ", handover: "ส่งมอบ" };
export const DOC_FILTERS = [["all", "ทั้งหมด"], ["quote", "ใบเสนอราคา"], ["invoice", "ใบแจ้งหนี้"], ["receipt", "ใบเสร็จ"], ["job", "ใบงาน"], ["handover", "ใบส่งมอบ"]];
const DOC_STATUS = {
