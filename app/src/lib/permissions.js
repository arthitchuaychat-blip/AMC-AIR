...
export const DEFAULT_PERMS = {
  ...
  hr:        { dashboard: V, kpi: V, customers: E, pipeline: V, reviews: V, followup: V, weborders: V, website: E, chat: E, email: E, teamchat: E, tasks: E, attendance: E, hr: E, boq: E, quote: E, invoice: E, receipt: E, adjnote: E, billing: E, receivables: V, payables: V, tax: N, profit: V, cashflow: E, loans: V, recurring: V, expenses: E, myjobs: N, joborders: E, handover: E, schedule: E, catalog: E, movements: E, jobs: N, subcontract: E, suppliers: E, prep: E, po: E, tools: V, handbook: V, settings: N },  // บุคคล = HR + ขาย + จัดซื้อ (PO/ผู้ขาย/เตรียมวัสดุ/รับของ)
