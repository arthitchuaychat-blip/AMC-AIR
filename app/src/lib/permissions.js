...
export const DEFAULT_PERMS = {
  ...
  finance:   { dashboard: V, customers: E, followup: N, weborders: V, website: N, chat: E, teamchat: E, tasks: E, attendance: E, hr: N, boq: V, quote: V, invoice: E, receipt: E, billing: E, receivables: V, payables: V, tax: V, profit: V, cashflow: E, expenses: E, myjobs: N, joborders: V, handover: V, schedule: V, catalog: V, movements: N, stockcount: V, jobs: V, subcontract: E, suppliers: E, prep: E, po: E, settings: N },
  sales:     { dashboard: V, customers: E, followup: V, weborders: V, website: E, chat: E, teamchat: E, tasks: E, attendance: E, hr: N, boq: E, quote: E, invoice: E, receipt: E, billing: E, receivables: V, payables: N, tax: N, profit: V, cashflow: E, expenses: E, myjobs: N, joborders: E, handover: E, schedule: E, catalog: E, movements: N, jobs: N, subcontract: E, suppliers: N, prep: E, po: E, settings: N },
