-- PROPOSED ONLY. Production application was blocked by automatic approval review.
-- Requires explicit approval for these 38 SELECT policy changes. Not an automatic migration.
